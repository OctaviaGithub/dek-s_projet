...
const initializeDatabase = () => {
    ...
    db.serialize(() => {
        ...
        db.run('CREATE TABLE IF NOT EXISTS peugeot (id INTEGER PRIMARY KEY, name TEXT, description TEXT , url_img TEXT)');
        ...
        const decl = db.prepare('INSERT OR IGNORE INTO peugeot (name, description, url_img) VALUES (?,?,?)');
        decl.run('Peugeot 406', 'Une 406 parfaite pour les longs trajets', 'https://www.ouestfrance-auto.com/p/yahooto/dvu2yb_346450_1_fc51d2b6619c68449d9b3fe9db10cecf117c87ff.jpg');
        decl.run('Peugeot 406 Coupé', 'Une peugepot 406 supérieur et très confortable','https://www.kuttler-kiefferautos.fr/573/1/occasion-peugeot-406-coupe-v6-pack-1998.jpg');
        decl.run('Peugeot 206','Meilleure voiture pour les débutants sortant du permis !','https://images.caradisiac.com/images/2/0/6/7/172067/S0-la-peugeot-206-en-occasion-les-meilleures-et-les-pires-versions-572179.jpg');
